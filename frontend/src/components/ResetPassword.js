...
function ResetPassword(){
    ...
    const doResetPassword = async event => {
        ...
        var obj = { new_password: newPassword.value, confirm_password: confirmPassword.value, user_id: user_data.id };
        ...
        try
        {
          ...
          {method:'POST',body:js,headers:{'Content-Type': 'application/json', 'Authorization':user_data.accessToken}});
